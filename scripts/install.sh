...
storage:
  ...
  backend_data_path: ${PRODOPS_BACKEND_DIR}
...
network:
  ...
  compose_port_range_start: 8100
  compose_port_range_end: 8200
...
# DO NOT commit this file — it is in .gitignore
#
# This file controls which modules are available on your installation.
# Enable a module by setting 'available: true' and running:
#   prodops module enable <module-name>
#
# Locked modules are not written to disk until unlocked via prodops CLI.
# =============================================================================
...
modules:
  ...
  linux:
    available: false   # unlocks after completing git module
    port: null

  docker:
    available: false   # unlocks after completing linux module
    port: null

  bash:
    available: false   # unlocks after completing docker module
    port: null

  cicd:
    available: false   # unlocks after completing bash module
    port: 8100         # Gitea UI exposed at localhost:8100
EOF
